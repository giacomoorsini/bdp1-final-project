...
The following chapters provide a brief overview of the concepts encountered during the project. The full explanation and workflow can be found in the project report, while all the commands used in each section are reported in the folder `./Code/`.

![image](https://github.com/user-attachments/assets/f9f206e3-7537-484c-bb1d-764b681e0de1)
...
![image](https://github.com/user-attachments/assets/a6e1d861-8357-4c3a-8be8-8d2ad8517f0c)

# Instructions
To replicate the work done, please download and follow the final report `BSPI_project_ltm_go.pdf` (https://github.com/giacomoorsini/bdp1-final-project/blob/main/BDPI_project_ltm_go.pdf). The commands used in the "coding" part can be found in the folder `./Code/` (https://github.com/giacomoorsini/bdp1-final-project/tree/main/Code), while the steps executed on AWS can be easily followed in the report. The `cost-time.xlsx` file (https://github.com/giacomoorsini/bdp1-final-project/blob/main/cost-time.xlsx) provides the final cost-time analysis of the infrastructure's performance.
